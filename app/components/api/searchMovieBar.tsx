...
// const SearchMovieBar = ({ onDataReceived }) => {
...
//         const url = `https://api.themoviedb.org/3/search/movie?query=${inputValue}&include_adult=false&language=fr-FR&page=1&api_key=eefc930faae17b67d376a80b08be54ef`;
